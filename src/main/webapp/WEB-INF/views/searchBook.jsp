...
<head>
<meta charset="UTF-8">
<title>도서 검색[${sessionScope.admin.admin_name}]</title>
    ...
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <div class="page-heading" style="padding: 20px;">
          <span class="subheading" style="font-family: 'BBTreeGL'; font-size: 50px; font-weight: bold;">도서 검색</span>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row" style="text-align: left;">
      <div class="col-lg-8 col-md-10 mx-auto" style="text-align: left;">
        <div class="post-preview" style="width: 100%; ">
            <br><hr>
            <form role="form" name="searchForm" action="/main/searchBook" method="get" class="form-inline" style="font-family: 'Noto Sans KR', sans-serif; font-size: 85%; font-weight: bold; width: 100%;">
				...
				<table class="table table-striped">
					...
					<tbody>
						<c:forEach var="rst" items="${rstList}">
							<tr class="rstTr" onclick="location.href='/main/updateBook?book_id=${rst.book_id}'" style="cursor:pointer;">
									<td>${rst.book_id}</td>
									<td>${rst.book_title}</td>
									<td>${rst.book_author}</td>
									<td>${rst.book_publisher}</td>
									<td>${rst.book_year}</td>
									<td>${rst.book_callnum}</td>
									<td>${rst.book_borrow}</td>
							</tr>
						</c:forEach>
					</tbody>
				</table>		
